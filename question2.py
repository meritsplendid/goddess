...
SOURCE_DB_NAME = "DVD RENTALS" # The database containing the film table
SOURCE_DB_USER = "postgres" # Your PostgreSQL username for dvdrental
SOURCE_DB_PASSWORD = "goddesscode" # Your PostgreSQL password for dvdrental
SOURCE_DB_PORT = "5433" # Your PostgreSQL port
...
TARGET_DB_NAME = "my_databases" # The database you want to create/connect to
TARGET_DB_USER = "postgres" # Your PostgreSQL username for my_database (can be the same as dvdrental user)
TARGET_DB_PASSWORD = "goddesscode" # Your PostgreSQL password for my_database
TARGET_DB_PORT = "5433" # Your PostgreSQL port
